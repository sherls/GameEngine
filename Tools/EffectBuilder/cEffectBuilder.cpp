/**
 ****************************************************************************************************
 * \file		cEffectBuilder.cpp
 * \brief		Implementation of cEffectBuilder class
 *
...
bool Tools::cEffectBuilder::Build_derived( const char* i_fileName_source, const char* i_fileName_target ) const
{
