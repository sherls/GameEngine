/**
 ****************************************************************************************************
 * \file		cMaterialBuilder.cpp
 * \brief		Implementation of cMaterialBuilder class
 *
...
bool Tools::cMaterialBuilder::Build_derived( const char* i_fileName_source, const char* i_fileName_target ) const
{
