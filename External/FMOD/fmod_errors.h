...
/*$ preserve end $*/
        ...
        case FMOD_ERR_EVENT_NOTFOUND:            return "The requested Studio API object could not be found. ";
        ...
        case FMOD_ERR_STUDIO_NOT_LOADED:         return "The specified resource is not yet loaded.";
